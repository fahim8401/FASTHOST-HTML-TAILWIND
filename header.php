      ...
      <div onclick='document.querySelectorAll("input.dropdown").forEach(input => input.checked = false)' class="group-has-[:checked]/nav:absolute left-0 top-0 h-0 w-0 group-has-[:checked]/nav:h-screen group-has-[:checked]/nav:w-screen">
		...
		<div id="mobile-menu" class="hidden md:hidden flex flex-col space-y-2 bg-blue-700 px-6 py-4">
			<a href="index.php" class="nav-link flex items-center px-4 py-2 rounded hover:bg-blue-800 focus:ring-2 focus:ring-blue-500">
				<!-- Home Icon -->
				<svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6" /> </svg> Home </a>
			<!-- Domain Dropdown in Mobile -->
			<div class="relative">
				<button id="mobile-domain-toggle" aria-haspopup="true" aria-expanded="false" class="flex justify-between items-center w-full px-4 py-2 rounded hover:bg-blue-800 focus:outline-none"> <span>Domain</span>
					<!-- Dropdown Arrow Icon -->
			...
			<div class="relative">
				<button id="mobile-hosting-toggle" aria-haspopup="true" aria-expanded="false" class="flex justify-between items-center w-full px-4 py-2 rounded hover:bg-blue-800 focus:outline-none"> <span>Hosting</span>
					<!-- Dropdown Arrow Icon -->
					<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
						<path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.584l3.71-3.354a.75.75 0 111.04 1.08l-4 3.625a.75.75 0 01-1.04 0l-4-3.625a.75.75 0 01.02-1.06z" clip-rule="evenodd" /> </svg>
				</button>
				...
				<div id="mobile-hosting-menu" class="hidden flex-col mt-2 space-y-2 bg-blue-700 rounded-md">
					...
					<a href="germany-hosting.php" class="flex items-center px-4 py-2 text-sm text-white hover:bg-blue-800 focus:ring-2 focus:ring-blue-500">
						<!-- Germany Icon --><i class="fa-solid fa-bangladeshi-taka-sign w-4 h-4 mr-2"></i> Cheap Hosting </a>
			...
			<div class="relative">
				<button id="mobile-reseller-toggle" aria-haspopup="true" aria-expanded="false" class="flex justify-between items-center w-full px-4 py-2 rounded hover:bg-blue-800 focus:outline-none"> <span>Reseller</span>
					<!-- Dropdown Arrow Icon -->
					<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
						<path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.584l3.71-3.354a.75.75 0 111.04 1.08l-4 3.625a.75.75 0 01-1.04 0l-4-3.625a.75.75 0 01.02-1.06z" clip-rule="evenodd" /> </svg>
				</button>
			...
			<div class="relative">
				<button id="mobile-vps-toggle" aria-haspopup="true" aria-expanded="false" class="flex justify-between items-center w-full px-4 py-2 rounded hover:bg-blue-800 focus:outline-none"> <span>VPS</span>
					<!-- Dropdown Arrow Icon -->
					<svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
						<path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 10.584l3.71-3.354a.75.75 0 111.04 1.08l-4 3.625a.75.75 0 01-1.04 0l-4-3.625a.75.75 0 01.02-1.06z" clip-rule="evenodd" /> </svg>
				</button>
			...
			<!-- Dedicated Server --><a href="dedicated-server.php" class="flex items-center px-4 py-2 rounded hover:bg-blue-800">
  Dedicated Server
</a>
			<!-- License --><a href="license.php" class="flex items-center px-4 py-2 rounded hover:bg-blue-800">
  License
</a>
			<a href="offers.php" class="nav-link flex items-center px-4 py-2 rounded hover:bg-blue-800 focus:ring-2 focus:ring-blue-500">
				<!-- Offers Icon -->
				<svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M3 3h18v18H3V3z" /> </svg> Offers <span class="bg-red-500 text-white text-xs px-2 py-0.5 rounded ml-2">1</span> </a>
			<a href="contact.php" class="nav-link flex items-center px-4 py-2 rounded hover:bg-blue-800 focus:ring-2 focus:ring-blue-500">
				<!-- Contact Icon -->
				<svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-3.582 8-8 8H11a8 8 0 01-8-8V4a8 8 0 018-8h2a8 8 0 018 8v8z" /> </svg> Contact </a>
